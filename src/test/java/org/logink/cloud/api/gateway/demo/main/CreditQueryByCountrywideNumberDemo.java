...
/**
 * @ClassName: CreditQueryByCountrywideNumberDemo
 * @Description: 全国车辆信息查询接口demo
 * @author: Xu Zhengwen
 * @date: 2018/11/26 15:26
 */
public class CreditQueryByCountrywideNumberDemo {
    public static void main(String[] args) {
        String appkey = "您的appkey";
        String appsecret = "您的appsecret";
        String url = "https://gateway.logink.org/credit/vehicleQuery/countrywide";
        //请求的body,json格式
