 ...
 * 对应测试类： /src/test/java/org/logink/cloud/api/gateway/demo/main/GPSLatestPositionDemo.java
 */
public class GPSLatestPositionDemo {
    public static void main(String[] args) {
        String appkey = "您的appkey";
        String appsecret = "您的appsecret";
        String url = "https://gateway.logink.cn/gps/getLatestPosition";
        //请求的body,json格式
